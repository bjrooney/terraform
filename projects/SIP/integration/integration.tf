...
module "integration_vpc" {
  ...
  public_whitelist     = "${var.pete_smart},${var.frontend_whitelist},${var.integration_az1_nat_eip},${var.integration_az2_nat_eip},${var.integration_az3_nat_eip},${var.build_az1_nat_eip}"
