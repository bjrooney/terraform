...
module "qa_vpc" {
  ...
  public_whitelist     = "${var.tfgm_whitelist},${var.pete_smart},${aws_eip.az1_nat_eip.private_ip}/32,${aws_eip.az2_nat_eip.private_ip}/32,${aws_eip.az3_nat_eip.private_ip}/32,${var.build_az1_nat_eip}"
